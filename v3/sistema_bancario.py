...
def inicia_contadores(banco: dict):
    Cliente.contador = banco["cliente"]["contador"]
    Conta.contador = banco["conta"]["contador"]
    Historico.contador = banco["historico"]["contador"]
    Transacao.contador = banco["transacao_atual"]
